...
const PROJECTS = [
  ...
  },
  {
    ...
    label: "// Client work: PR & marketing agency",
    ...
    problem:
      "A PR and marketing agency's journalist database goes stale the moment it's built. New reporters appear on beats daily, old contacts move outlets, and nobody has time to re-verify a thousand rows by hand, so pitches go to the wrong people.",
    solution:
